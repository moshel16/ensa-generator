...
def build_docx(summary: str, topic: str) -> bytes:
    ...
    def run_font(run, size_pt, color, bold=False, font='Arial', italic=False):
        ...
        # RTL מפורש על ה-run — מבטיח יישור ימין גם בשורות ארוכות
    ...
    def cell_add_para(cell, jc='right'):
        """מוסיף פסקה לתא עם RTL מפורש"""
        from docx.text.paragraph import Paragraph as DocxPara
        p = cell._tc.add_p()
        para = DocxPara(p, cell._tc)
        pPr = para._p.get_or_add_pPr()
        # bidi מפורש — מבטיח RTL גם בלי לסמוך על defaults
