...
def build_docx(summary: str, topic: str) -> bytes:
    ...
    def make_bidi_table(doc, paragraphs_fn, border_hex=BLUE_HEX, fill_hex=LB_HEX):
        ...
        # ללא table.style — python-docx מוסיף tblStyle+auto width שמבטל bidiVisual

        # בנה tblPr מאפס בדיוק כמו ACL_Final
        tbl = table._tbl
        # מחק tblPr קיים אם יש
